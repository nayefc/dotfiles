;;; package --- Summary
;;; Commentary:
;;; This is not my code, its taken from cmake-ide.el as I had to customize cmake-ide
;;; as I only would like to use the automated rtags setup in it. I also run rdm
...
(provide 'init-rtags-cmake-ide)
;;; init-rtags-cmake-ide ends here
