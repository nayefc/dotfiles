...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ns-auto-titlebar rmsbolt flycheck-rtags clang-format use-package cmake-ide yasnippet-snippets yasnippet levenshtein pytest realgud package-build shut-up epl git commander f dash s virtualenvwrapper elisp--witness--lisp string-inflection shx
