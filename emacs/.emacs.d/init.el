...
(custom-set-variables
 ...
 '(package-selected-packages
   '(all-the-icons-gnus toml-mode all-the-icons-ivy-rich go-mode dired-narrow popwin nord-theme blacken posframe ini-mode eyebrowse ansible-vault cff cquery zeno-theme yasnippet-snippets yaml-mode virtualenvwrapper use-package solarized-theme smartparens shx rtags rmsbolt realgud ns-auto-titlebar neotree multiple-cursors modern-cpp-font-lock magit ivy-hydra ivy-explorer itail indent-tools highlight-symbol highlight-indentation google-c-style git-gutter+ flycheck-irony fill-column-indicator expand-region exec-path-from-shell dumb-jump diminish dashboard counsel-projectile company-tabnine company-irony-c-headers company-irony cmake-ide clang-format buffer-move all-the-icons-ivy all-the-icons-dired ag ace-window)))
